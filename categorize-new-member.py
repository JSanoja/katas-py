...
Input
Input will consist of a list of pairs. Each pair contains information for a single potential member. Information consists 
...
(in Haskell and C: Open or Senior) stating whether 
...
def open_or_senior(data):
    arr = []
    for d in data:
        arr.append("Senior") if d[0] >= 55 and d[1] > 7 else arr.append("Open")
    return arr
